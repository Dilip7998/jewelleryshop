...
export function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    <article className="group overflow-hidden rounded-lg border border-gold/18 bg-white shadow-premium transition duration-300 hover:-translate-y-1 hover:shadow-glow">
      ...
      <div className="p-5">
        ...
        <h3 className="mt-2 font-display text-2xl leading-7 text-charcoal">
          {product.name}
        </h3>
